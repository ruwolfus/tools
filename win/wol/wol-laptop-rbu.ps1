...
#Send-WakeOnLan -MacAddress "d4-be-d9-44-3d-e5" -LocalIPAddress (Get-NetIPAddress | Where-Object { $_.InterfaceAlias -eq "Ethernet" }).IPAddress
Send-WakeOnLan -MacAddress "d4-be-d9-44-3d-e5" -LocalIPAddress "10.34.25.3"
